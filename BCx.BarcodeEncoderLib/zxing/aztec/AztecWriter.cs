...
namespace ZXing.Aztec
{
    ...
    /// </summary>
    public sealed class AztecWriter
    {
        ...
        /// The generated barcode as a Matrix of unsigned bytes (0 == black, 255 == white)
        /// </returns>
        public BitMatrix encode(String contents, int width, int height, IDictionary<EncodeHintType, object> hints)
        {
        ...
        private static BitMatrix encode(String contents, int width, int height, Encoding charset, int eccPercent, int layers)
        {
