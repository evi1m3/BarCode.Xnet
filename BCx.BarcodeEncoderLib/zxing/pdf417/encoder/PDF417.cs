...
namespace ZXing.PDF417.Internal
{
   ...
   internal sealed class PDF417
   {
      ...
      //private const float PREFERRED_RATIO = 4.0f;
      ...
      internal void generateBarcodeLogic(String msg, int errorCorrectionLevel, float PREFERRED_RATIO)
      {
         ...
         int[] dimension = determineDimensions(sourceCodeWords, errorCorrectionCodeWords, PREFERRED_RATIO);
      ...
      private int[] determineDimensions(int sourceCodeWords, int errorCorrectionCodeWords, float PREFERRED_RATIO)
      {
         float ratio = 0.0f;
         int[] dimension = null;
         ...
         if (dimension == null)
         {
            throw new Exception("Unable to fit message in columns");
         }
